...
WynikDialog::WynikDialog(wxWindow* parent,wxWindowID id)
{
    ...
    PlayAgainButton = new wxButton(this, ID_BUTTON2, _("Zagraj jeszcze ra"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
    ...
    ExitButton = new wxButton(this, ID_BUTTON1, _("Wyjdz z programu"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
