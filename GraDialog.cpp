...
GraDialog::GraDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    KrupierBitmap = new wxStaticBitmap(this, ID_STATICBITMAP1, wxBitmap(wxImage(_T("images/guy1.png")).Rescale(wxSize(200,200).GetWidth(),wxSize(200,200).GetHeight())), wxDefaultPosition, wxSize(200,200), 0, _T("ID_STATICBITMAP1"));
    ...
    GuzikiSizer = new wxFlexGridSizer(4, 1, 0, 0);
...
void GraDialog::DealInitialDealerCards()
{
    ...
    int newWidth = 100;
    int newHeight = 80 * 1.6;
    bmp1 = bmp1.ConvertToImage().Rescale(newWidth, newHeight, wxIMAGE_QUALITY_HIGH);
